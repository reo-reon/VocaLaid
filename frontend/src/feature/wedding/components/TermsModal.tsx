    ...
    >
      ...
      >
        ...
        <div className="overflow-y-auto px-6 py-5 space-y-6 text-sm text-gray-700 ja leading-relaxed">
          ...
          <section>
            <h3 className="font-semibold text-gray-900 mb-2">第1条（目的）</h3>
            <p>
          ...
          <section>
            <h3 className="font-semibold text-gray-900 mb-2">第2条（禁止事項）</h3>
          ...
          <section>
            <h3 className="font-semibold text-gray-900 mb-2">第3条（個人情報の取り扱い）</h3>
            <p>
          ...
          <section>
            <h3 className="font-semibold text-gray-900 mb-2">第4条（アレルギー対応について）</h3>
            <p className="mb-2">
          ...
          <section>
            <h3 className="font-semibold text-gray-900 mb-2">第5条（免責事項）</h3>
            <p>
        ...
        <div className="px-6 py-4 border-t border-gray-200 flex justify-end">
          <button
            onClick={onClose}
            className="px-6 py-2 bg-black text-white text-sm rounded-lg hover:bg-gray-800 transition-colors ja"
          >
            閉じる
          </button>
        </div>
