  ...
  return (
    <section id="message" className="py-16 md:py-24 bg-white">
      <div className="container mx-auto px-4">
        ...
        >
          <h2>
            <span className="block text-gray-700 en" style={{letterSpacing: '0.05em', fontSize: '42px', fontWeight: 400}}>MESSAGE</span>
            <span className="block text-gray-900 ja" style={{fontSize: '15px', fontWeight: 400, marginTop: '-8px'}}>メッセージ</span>
          </h2>
        </div>
        ...
        >
          <p className="text-gray-700 leading-relaxed whitespace-pre-wrap md:text-base ja" style={{lineHeight: 1.9, letterSpacing: '0.15em'}}>
            {greetingMessage}
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-12 max-w-5xl mx-auto">
          ...
          >
            ...
            <div className="mb-6">
              ...
              <p className="text-lg text-gray-900 mb-4 ja" style={{fontSize: '1.2rem'}}>
            ...
            <p className="text-gray-700 leading-relaxed text-sm whitespace-pre-wrap ja" style={{lineHeight: 1.9}}>
              {groom.introduction}
            </p>
          </div>
